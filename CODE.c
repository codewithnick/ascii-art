	...
	{
		char** character=getCharGrid();
		character[0][0]=character[01][02]=character[0][5]=character[0][6]=character[0][7]=character[5][1]=character[5][6]='_';
		...
		character[0][3]=character[0][4]=character[1][1]=character[1][2]=character[1][5]=character[1][6]=character[2][1]=character[2][3]=character[2][4]=character[2][6]=character[3][1]=character[3][6]=character[4][1]=character[4][3]=character[4][4]=character[4][6]=character[5][3]=character[5][4]='\0';
		return character;
	}
