...
public:
    ...
    */
    ...
    char **l()
    {
        ...
        char **m()
        {
            ...
            //Enter the character grid in ROWS X COLS
            character[0][0]='.';
            character[0][1]=character[0][3]=character[0][5]=character[3][1]=character[3][3]=character[3][5]='_';
            character[1][0]=character[2][0]=character[1][6]=character[2][6]=character[3][2]=character[3][4]=character[3][0]=character[3][6]='|';
            character[1][2]=character[1][4]='\'';
    ...
    */
...

    {
        ...
        character[2][0] = character[2][2] = character[3][1] = character[3][3] = character[3][3] = '\\';
        character[2][3] =
            character[3][0] = '/';
        return character;
    }
    ...
    char **four()
    {
        ...
        character[0][2] = character[0][3] = character[3][3] = character[2][1] = character[3][3] = '_';
