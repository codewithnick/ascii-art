...
public:
    ...
    */
        ...
        char **g()
        {
            ...
            //Enter the character grid in ROWS X COLS
            character[0][1] = character[0][2] = character[0][3] = character[2][1] = character[3][1] = character[3][2] = character[3][3] = character[2][1] = '_';
    ...
    */
    ...
    {
        char **character = getCharGrid(4, 5);
        character[0][2] = character[0][3] = character[2][2] = character[3][3] = '_';
