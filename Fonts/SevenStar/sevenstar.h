  ...
  int col = col_num(colnumber);
	for(int i=0;i<7;i++)
	{
		for(int j=0;j<7;j++)
		{
			...
			if(i==1||i==5)
			{
				if(j==0||j==1||j==5||j==6) letters[i][j + col] = '%';
				else letters[i][j + col] = ' ';
   ...
   int col=col_num(colnumber);
    for(int i=0;i<7;i++)
    {
        for(int j=0;j<7;j++)
        {
            ...
            if(i==3)
            {
                if(j==4||j==5||j==6) letters[i][j + col] = ' ';
                else letters[i][j + col] = '%';
            }

            if(i==2||i==4)
            {
                if(j==2||j==5||j==6) letters[i][j + col] = ' ';
                else letters[i][j + col] = '%';
            }
        }
   ...
   int col=col_num(colnumber);
	for(int i=0;i<7;i++)
	{
		for(int j=0;j<7;j++)
		{
			...
			if(i==6)
			{
				if(j==0||j==3||j==4)letters[i][j + col] = ' ';
				else letters[i][j + col] = '%';
			}
