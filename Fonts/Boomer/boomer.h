...
public:
	...
	{	
		...
		char** character = getCharGrid();
		character[0][0]=character[0][6]=character[1][2]=character[1][3]=character[1][4]=character[2][0]=character[2][1]=character[2][3]=character[2][5]=character[2][6]=character[3][0]=character[3][1]=character[3][3]=character[3][5]=character[3][6]=character[4][0]=character[4][3]=character[5][6]=character[5][0]=' ';
