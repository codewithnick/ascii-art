...
public:
	...
	char** N()
	{
		...
		character[5][6]='/';
		character[0][2]=character[0][3]=character[0][4]=character[0][0]=character[0][6]=character[1][1]=character[1][3]=character[1][5]=character[2][1]=character[2][2]=character[2][5]=character[3][1]=character[3][3]=character[3][5]=character[4][1]=character[4][4]=character[4][5]='\0';
		character[3][2]='.';
		character[3][4]='`';
		return character;
	}
