...
public:
  ...
  char** B(){
	  ...
	  char** b(){
        char** character = getCharGrid();
        character[1][1]=character[6][1]=character[6][3]=character[6][4]=character[3][3]=character[3][4]=character[4][3]=character[5][3]='_';
        character[2][0]=character[3][0]=character[4][0]=character[5][0]=character[6][0]=character[2][2]=character[3][2]=character[5][2]=character[5][6]='|';
		character[5][4]=')';
		character[6][2]='.';
		character[4][2]='\'';
		character[4][5]='\\';
  ...
  char** Z()
	{
		...
		character[1][1]=character[1][2]=character[1][3]=character[1][4]=character[1][5]=character[1][6]=character[2][1]=character[2][2]=character[2][3]=character[5][5]=character[5][6]=character[5][4]=character[6][1]=character[6][2]=character[6][3]=character[6][4]=character[6][5]='_';
		character[3][3]=character[3][5]=character[2][6]=character[4][2]=character[4][4]=character[5][1]=character[5][3]=character[6][6]='/';
		character[6][0]='\\';
		character[2][0]='|';
		return character;
	}
