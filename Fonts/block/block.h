...
public:
    ...
    */
    ...
    char **N()
    {
        ...
        char **O()
        {
            char **character = getCharGrid(12,20);
            character[0][2]=character[0][3]=character[0][4]=character[0][5]=character[0][6]=character[0][7]=character[0][8]=character[0][9]=character[0][10]=character[0][11]=character[0][12]=character[0][13]=character[0][14]=character[0][15]=character[0][16]=character[0][17]=character[1][3]=character[1][4]=character[1][5]=character[1][6]=character[1][7]=character[1][8]=character[1][9]=character[1][10]=character[1][11]=character[1][12]=character[1][13]=character[1][14]=character[1][15]=character[1][16]=character[4][9]=character[4][10]=character[6][9]=character[6][10]=character[9][3]=character[9][4]=character[9][5]=character[9][6]=character[9][7]=character[9][8]=character[9][9]=character[9][10]=character[9][11]=character[9][12]=character[9][13]=character[9][14]=character[9][15]=character[9][16]=character[10][2]=character[10][3]=character[10][4]=character[10][5]=character[10][6]=character[10][7]=character[10][8]=character[10][9]=character[10][10]=character[10][11]=character[10][12]=character[10][13]=character[10][14]=character[10][15]=character[10][16]=character[10][17]='-';
            character[0][1]=character[0][18]=character[1][2]=character[1][17]=character[3][6]=character[3][13]=character[4][8]=character[4][11]=character[7][7]=character[7][12]='.';
            character[1][0]=character[1][19]=character[2][0]=character[2][2]=character[2][17]=character[2][19]=character[3][0]=character[3][2]=character[3][17]=character[3][19]=character[4][0]=character[4][2]=character[4][17]=character[4][19]=character[5][0]=character[5][2]=character[5][5]=character[5][7]=character[5][12]=character[5][14]=character[5][17]=character[5][19]=character[6][0]=character[6][2]=character[6][17]=character[6][19]=character[7][0]=character[7][2]=character[7][17]=character[7][19]=character[8][0]=character[8][2]=character[8][17]=character[8][19]=character[9][0]=character[9][19]='|';
            ...
            character[3][7]=character[6][11]=character[7][13]=character[9][2]=character[9][17]=character[10][1]=character[10][18]='\'';
